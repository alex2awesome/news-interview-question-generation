...
from data_processing.vllm_classify_all_questions import classify_each_question
import logging
...
if __name__ == "__main__":
    ...
    print(df)
    interviewNum = len(df)
    classify_each_question(df, num_interviews=interviewNum, model_name="meta-llama/Meta-Llama-3-8B-Instruct")
