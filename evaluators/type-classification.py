...
from helper_functions.py import extract_text_inside_brackets, get_openai_client
...
def classify_question(transcript_section):
    completion = openai_client.chat.completions.create(
          ...
          messages=[
                ...
                {"role": "user", "content": CLASSIFY_USING_TAXONOMY}
          ]
    )
...
if __name__ == "__main__":
    ...
    """
    print(classify_question(transcript))