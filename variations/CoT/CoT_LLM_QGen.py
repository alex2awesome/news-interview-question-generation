...
if __name__ == "__main__":
    ...
    LLM_questions_df = LLM_question_process_dataset(CoT_LLM_QUESTION_PROMPT, df, output_dir="output_results/CoT", model_name="meta-llama/Meta-Llama-3-70B-Instruct") # saves LLM_questions in QA_Seq_LLM_generated.csv
